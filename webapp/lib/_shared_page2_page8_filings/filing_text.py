...
#
# 2026-07-30 수정: 종결부호 바로 뒤가 아니라 닫는 인용부호를 하나 사이에 두고 오는 경우
# (보도자료 인용문에서 흔함: 큰따옴표로 인용을 닫으면서 문장도 끝나는 ‘…strategy.” Goulden
# previously…’ 형태)를 경계로 못 잡는 문제를 실측(HPE 임원 영입 보도자료)으로 발견 — 두
# 문장이 하나로 묶여서 앞 문장의 "our"가 뒷문장(실제로는 EMC-Dell 2016년 인수 얘기, HPE와
# 무관)의 자기지칭인 것처럼 잘못 인식됐다. 종결부호 바로 뒤에 닫는 인용부호가 있어도
# 경계로 인정한다.
